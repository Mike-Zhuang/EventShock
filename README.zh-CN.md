...
EventShock Lab 是一个已经部署的研究原型，面向**所有希望理解市场事件如何传播的人**。自主研究型个人投资者、市场风险分析人员、研究者和教育者，都可以比较一组基准模拟和一组只改变单一已声明条件的配对模拟。产品帮助人研究风险传播机制，而不是用预测代替人的判断。
...
目标用户由共同任务定义，而不是由职位定义。EventShock 适合希望获得比市场叙事或一句 AI 预测更严谨研究过程的人：

- 没有量化研究团队、但希望独立检验事件观点的个人投资者；
- 需要在可复核流程中比较事件风险机制的分析人员和研究团队；
- 学习或研究行为金融、市场结构及人机协作决策的研究者、教师和学生。

AI 引导与高级工作区服务于同一受众的不同熟练程度。高级控制代表方法深度，不是“仅限机构”的另一套产品。EventShock 可以讨论**已声明情景下**的方向性含义，但不了解用户的持仓、财务状况、风险承受能力或实时市场，也不提供个性化荐股、自动交易或结果保证。
...
EventShock Lab 是仍在接受测试的**课程研究原型**，不是经过外部校准的预测产品。历史案例用于展示流程和内部机制，不代表已经证明现实预测能力。10 对随机种子适合课堂演示，不足以支持生产风险结论。面向个人投资者、专业分析人员、研究者和教育者的可用性、理解度、信任与误用测试仍在进行。用户仍需核对来源权利、保护私人数据，并在已声明模型假设内解释结果。
